 ...
 */
@Service
@ActivemqSender("boms.accountingdept.syncrelation")
public class AccountingDeptSyncRelationSender extends VirtualAbstractSender{
	...
	public void sendMessage(int accountingId,String accountingOrgName,
		...
		try {
			...
			logger.error("核算组织同步维护eas对应关系MQ消息异常，"+msg,e);
			mailHelper.sendMQErrorMessage("核算组织同步维护核算部门对应关系发送MQ消息异常，"+msg);
		}
	}
