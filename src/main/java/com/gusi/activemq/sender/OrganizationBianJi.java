 ...
 *
 * @Author: fdj
 * @Create: 13-12-19 下午1:57
 * @Description: 组织编辑消息发送类
 * To change this template use File | Settings | File Templates.
 */
@Service
@ActivemqSender("boms.organization.bianji")
public class OrganizationBianJi extends VirtualAbstractSender {

    private Log log = LogFactory.getLog(OrganizationBianJi.class);
