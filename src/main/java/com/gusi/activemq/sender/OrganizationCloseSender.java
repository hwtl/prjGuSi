 ...
 */
@Service
@ActivemqSender("boms.organization.close")
public class OrganizationCloseSender extends VirtualAbstractSender {
    ...
    public void sendMessage(int orgId,String orgName,Integer parentId){
    	...
    	try {
			...
			logger.error("组织关闭发送MQ消息异常，"+orgMsg,e);
			mailHelper.sendMQErrorMessage("组织关闭发送MQ消息异常，"+orgMsg);
		}
    }
}
